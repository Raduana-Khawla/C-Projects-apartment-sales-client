...
<video autoPlay loop muted
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption>
     ...
     <div className="col-md-4 my-5 text-light">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nostrum natus illum rem, fugit assumenda fugiat repellat nulla nobis cupiditate mollitia quaerat reprehenderit, velit veniam molestiae doloremque non atque accusantium repellendus.</div>
     </div>
     </section>
    )};
